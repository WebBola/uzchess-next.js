export default function Anonis() {
    return <div className=" flex flex-col items-start relative w-full p-4  bg-[#0B4789] overflow-hidden rounded-[8px]">
                ...
                <button className="flex items-center justify-center gap-2 w-[149px] bg-[#1C92E0] text-[16px] text-white rounded-[4px] py-2 px-5 font-poppins font-[500] items-center h-[40px] cursor-pointer hover:bg-[#1676b5] transition-colors mt-2 rounded-[8px] z-1">Batafsil <img src="/Vector (Stroke).svg" alt="" /></button>
            </div>
}